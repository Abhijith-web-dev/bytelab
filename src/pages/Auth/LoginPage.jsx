...
import { Code2, ArrowRight, ShieldCheck, UserCheck } from 'lucide-react';
import { Button } from '../../components/ui/Button.jsx';
import { useAuthStore } from '../../stores/authStore.js';

export function LoginPage() {
  const navigate = useNavigate();
  const { loginWithEmail, loginAsGuest, authLoading, authError } = useAuthStore();
    ...
    <div className="min-h-screen bg-white flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-[400px] space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-[24px] font-semibold text-black tracking-tight">Sign in to ByteLab</h1>
